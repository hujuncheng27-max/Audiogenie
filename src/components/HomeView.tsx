          ...
          <div className="relative space-y-8">
            ...
            <div className="space-y-5 max-w-3xl">
              ...
              <p className="text-base md:text-lg leading-relaxed text-on-surface-variant max-w-2xl">
                AudioGenie is a multi-agent AI studio that generates speech, music, sound effects, and
      ...
      <section ref={showcaseRef} className="space-y-8">
        <div className="border-b border-outline-variant/30 pb-4">
          ...
          <p className="text-sm text-on-surface-variant mt-2">
            Sample outputs generated by AudioGenie from different input types and output categories.
          </p>
        </div>
